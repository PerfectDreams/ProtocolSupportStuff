...
<h1 align="center">🌟 ProtocolSupportStuff 🌟</h1>
<p align="center">
<a href="https://jenkins.perfectdreams.net/job/ProtocolSupportStuff/"><img src="https://jenkins.perfectdreams.net/job/ProtocolSupportStuff/badge/icon"></a>
<a href="https://github.com/PerfectDreams/ProtocolSupportStuff/blob/master/LICENSE"><img src="https://img.shields.io/badge/license-AGPL%20v3-lightgray.svg"></a>
</p>
<p align="center">
<a href="https://github.com/PerfectDreams/ProtocolSupportStuff/watchers"><img src="https://img.shields.io/github/watchers/PerfectDreams/ProtocolSupportStuff.svg?style=social&label=Watch"></a>
<a href="https://github.com/PerfectDreams/ProtocolSupportStuff/stargazers"><img src="https://img.shields.io/github/stars/PerfectDreams/ProtocolSupportStuff.svg?style=social&label=Stars"></a>
</p>
<p align="center">A plugin that does... stuff, I guess. Disable Minecraft versions (even the current server version!), remap blocks/items for older versions, allow pre-1.9 PvP for pre-1.9 clients in your 1.9+ server and much more!</p>
...
* Eu não irei dar suporte caso você queria usar o nosso projeto no seu servidor sem dar nada em troca para o PerfectDreams, lembre-se, a licença do projeto é [AGPL v3](https://github.com/PerfectDreams/ProtocolSupportStuff/blob/master/LICENSE), você é **obrigado a deixar todas as suas alterações no projeto públicas**!
...
Nós utilizamos várias [dependências no código-fonte](https://github.com/PerfectDreams/ProtocolSupportStuff/blob/master/pom.xml) deste projeto, obrigado a todos os mantenedores das dependências! Sem vocês, talvez nosso projeto não iria existir (ou teria várias funcionalidades reduzidas ou talvez até inexistentes!)
